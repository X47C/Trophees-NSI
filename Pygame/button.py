...
class Button:
    ...
    def draw(self, surf:pg.surface, font:pg.font, asset:str = None, bg:tuple = (30, 144, 255)) -> None:
        """
        Dessine le bouton sur 'surf' avec le texte et la couleur de fond donnés.
        """
        ...
        # texte grisé si le champ est vide
    ...
    def collide(self, pos: tuple) -> bool:
        """
        Renvoie True si la position 'pos' est dans le bouton.
        """
    ...
    def is_clicked(self, mouse_pos: tuple, button_pos: tuple) -> bool:
        """
        Renvoie True si le bouton est cliqué en tenant compte du décalage 'button_pos'.
        """
    ...
    def handle_event(self, event: pg.event, offset: tuple = (0, 0)) -> bool:
        """
        Gère les clics et la saisie clavier pour les boutons éditables.
        """
        ...
        # saisie clavier si le champ est actif
    ...
    def get_number(self) -> None | int | float:
        """
        Renvoie la valeur saisie sous forme de nombre, ou None si vide.
        """
        if self.value == "":
            return None
    ...
    def set_value(self, v: int) -> None:
        """
        Définit la valeur affichée dans le bouton éditable.
        """
        if self.editable:
    ...
    def description_slice(self, text:str) -> str:
        """
        Découpe le texte de description en lignes de longueur fixe.
        """
        step = 45
    ...
    def description(self) -> None:
        """
        Affiche la boite de description au survol du bouton.
        """
